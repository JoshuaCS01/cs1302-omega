...
public class IdleCat extends ImageView {
    ...
    /**
     * Checks to see if the snake head has come into contact
     * with the apple if it has then a new apple is generated
     * randomly.
     * @param player the head of the snake.
     * @return returns a boolean depending on whether or not
     * the snakes head came into contact with the apple.
     */
